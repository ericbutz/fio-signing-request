...
const opts = {
    ...
    abiProvider: {
        ...
        getAbi: async (account) => (await fetch('http://testnet.fioprotocol.io/v1/chain/get_abi', {body: `{"account_name": "${account}"}`, method: 'POST'})).json().then(response => {return response.abi})
    }
}
